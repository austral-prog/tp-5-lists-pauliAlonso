...
def list_of_lists(lista_de_listas):
    ...
    primera_lista = lista_de_listas[0][:2]

    segunda_lista = lista_de_listas[1][1:4]

    tercera_lista = lista_de_listas[2][-2:]

    lista_nueva = [primera_lista, segunda_lista, tercera_lista] 
